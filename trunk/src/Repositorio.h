...
public:
    ...
    bool getDiff(std::ostream& os, const string& a_Username, const string& a_Password, const string& a_VersionA, const string& a_VersionB, const string& a_Filename = "");
    ...
    bool getListOfChanges(std::ostream& os, const string& a_Username, const string& a_Password, int a_Num, bool isAdmin);
