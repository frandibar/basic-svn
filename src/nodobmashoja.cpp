...
NodoBMasHoja::NodoBMasHoja(int Numero, int Padre, int HnoIzquierdo, int HnoDerecho)
    : NodoBMas(Numero, 0, Padre)
{
    _hnoIzquierdo = HnoIzquierdo;
    _hnoDerecho   = HnoDerecho;
}

void NodoBMasHoja::read(char* buffer)
{
...
void NodoBMasHoja::write(char* buffer)
{
    char* nextByte = buffer;
...
int NodoBMasHoja::searchFile(const char* key)
{
    char* auxKey;
	char* auxFileName;
	int longClave;
...
int NodoBMasHoja::searchFileAndVersion(const char* fileName,int version){
    char* auxKey;
	char* auxFileName;
	char* versionStr;
	int auxVersion;
...
NodoBMas* NodoBMasHoja::split(int Numero, 
							  char* arreglo,int bytesArreglo,int clavesArreglo,
							  char** claveAlPadre)
{
	int longClave = 0;
	int offsetArreglo = 0;
    NodoBMasHoja* ret = new NodoBMasHoja(Numero, _padre, _id, _hnoDerecho);
...
void NodoBMasHoja::promoteRoot(NodoBMas** nodo1,NodoBMas** nodo2, int id1, int id2,
