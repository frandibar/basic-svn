...
VarLenNode* VarLenLeafNode::split(int Numero, char* arreglo,int bytesArreglo,int clavesArreglo, char** claveAlPadre)
{
    int longClave = 0;
    int offsetArreglo = 0;
...
void VarLenLeafNode::promoteRoot(VarLenNode** nodo1,VarLenNode** nodo2, int id1, int id2, int clavesArreglo,char** arreglo, int bytesArreglo,
        char** claveARaiz)
{
